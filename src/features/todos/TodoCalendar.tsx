  ...
  const calendarDays = useMemo(() => {
    ...
    while (current <= endDate) {
      ...
      days.push({
        ...
        isCurrentMonth:
          viewMode === "month" ? current.getMonth() === month : true,
        ...
        >
          {calendarDays.map((day, index) => (
            ...
            >
              {/* Date */}
              <div
                className={`font-medium mb-1 flex-shrink-0 ${
              ...
              {/* Tasks */}
              <div
                className={`space-y-1 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 ${
                ...
                {day.tasks.map((task) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-1 rounded cursor-pointer hover:shadow-sm transition-shadow border-l-2 ${getTaskStatusColor(
                        task.status
                    ...
                    >
                      <div className="flex items-center space-x-1">
                        <div
                          className={`rounded-full flex-shrink-0 ${getTaskPriorityColor(
                            task.priority
                      ...
                      {project && (
                        <div
                          className={`${viewMode === "day" ? "mt-2" : "mt-1"}`}
                        >
                          <span
                  ...
                  <div className="mb-6">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(
                          getTaskSummary(selectedDay.tasks).statusCounts
                        ).map(([status, count]) => (
                          <div
                            key={status}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(
                          getTaskSummary(selectedDay.tasks).priorityCounts
                        ).map(([priority, count]) => (
                          <div
                            key={priority}
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center space-x-2 mb-1">
                                  <div
                                    className={`w-3 h-3 rounded-full ${getTaskPriorityColor(
                                      task.priority
                                    )}`}
                                  />
