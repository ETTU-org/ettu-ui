        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-300">Mode Développement</div>
              <button
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
        ...
        <p className="text-gray-400 text-sm mb-4">Métriques de l'application</p>
        <div className="space-y-2">
          <div className="flex items-center justify-between">
...
function SecurityTab() {
  const [testResults, setTestResults] = useState<TestResult | "running" | null>(
    null
  );
...
function LogsTab() {
  const [logs] = useState([
    {
      id: 1,
      timestamp: "2025-07-14 22:45:12",
      event: "security_test_passed",
      message: "Tests de sécurité exécutés avec succès",
    },
    {
      id: 2,
      timestamp: "2025-07-14 22:40:05",
      event: "xss_attempt_blocked",
      message: 'Tentative XSS bloquée: <script>alert("test")</script>',
    },
    {
      id: 3,
      timestamp: "2025-07-14 22:35:22",
      event: "invalid_filename",
      message: "Nom de fichier invalide rejeté: malware.exe",
    },
    {
      id: 4,
      timestamp: "2025-07-14 22:30:15",
      event: "storage_migration",
      message: "Migration automatique du stockage terminée",
    },
  ]);
                    ...
                    <span
                      className={`px-2 py-1 rounded text-xs ${
                        ...
                        log.event.includes("invalid")
                          ...
                          : log.event.includes("passed") ||
                            log.event.includes("migration")
      ...
      const debugData = {
        ...
        performance: {
          memory: (performance as PerformanceWithMemory).memory
            ? {
                usedJSHeapSize: (performance as PerformanceWithMemory).memory!
                  .usedJSHeapSize,
                totalJSHeapSize: (performance as PerformanceWithMemory).memory!
                  .totalJSHeapSize,
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Exécute les tests au démarrage
              </p>
            </div>
